      ...
      <div className="relative w-full flex flex-col justify-start gap-4 lg:gap-0 lg:min-h-[calc(100vh+400px)] lg:justify-between m-0 p-0">
        ...
        */}
        ...
        {/* 
          ...
          =========================================================
        */}
        <section id="why-us" className="relative w-full h-auto lg:h-[400px] pt-4 pb-16 sm:pb-24 lg:py-0 flex items-center justify-end px-4 sm:px-12 lg:pl-12 lg:pr-0 lg:mr-0 z-20">
          <motion.div
